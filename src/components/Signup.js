...
const SignUpSignIn = () => {
  ...
  const signUpWithEmail = useCallback(async (e) => {
    setLoading(true);
    e.preventDefault();
    try {
  ...
  }, [email, password, createUserDocument, navigate]);

  const signInWithEmail = useCallback(async (e) => {
    setLoading(true);
    e.preventDefault();
    try {
